...
//! emission sequencing.
//!
//! Wave 6 migration: the reminder body routes through the Roles API so
...
/// `Roles::brand` so the lavender lock survives D-05 fallback. The
...
mod tests {
    ...
    /// D-05 graceful degrade — without Roles, the reminder line falls
