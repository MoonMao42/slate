...
<sub>* Recordings render silently in v0.3.0; v2.2.x will refresh with audio once the curated SFX library lands.</sub>

## Neovim follows along

Slate ships 18 Neovim colorschemes mirroring every terminal family and reloads open buffers the moment you switch.
...
Last regenerated by hand on 2026-04-28. Future drift will be caught by the docs-invariants test in `tests/docs_invariants.rs`. Swatch order, left to right: background · foreground · brand accent · red.
