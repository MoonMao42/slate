...
- README install command: `brew install MoonMao42/tap/slate-cli`
...
1. Confirm README still uses `brew install MoonMao42/tap/slate-cli`.
...
8. Smoke-check a fresh-ish macOS install path with `brew install MoonMao42/tap/slate-cli`.
...
- The first release should be watched manually to confirm the generated formula lands in the tap and `brew install MoonMao42/tap/slate-cli` resolves correctly.
