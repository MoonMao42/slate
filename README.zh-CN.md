...
slate 内置 18 套对应全部主题家族的 Neovim 配色，自动选中跟当前主题匹配的那套，切换主题时已打开的 buffer 当场重载。

<p align="center">
  <img src="./assets/nvim-before.png" alt="Neovim before — detached from terminal theme" width="700" />
  <br />
  <sub>之前 —— 终端已换色，编辑器还是老样子。</sub>
</p>

<p align="center">
  <img src="./assets/nvim-after.png" alt="Neovim after — synced with terminal theme" width="700" />
  <br />
  <sub>之后 —— <code>slate theme</code> 让整套包括编辑器一起走。</sub>
</p>

兼容 LazyVim / kickstart.nvim / 自己手写的 init.lua。不想要可以关：`slate config set editor disable`。
