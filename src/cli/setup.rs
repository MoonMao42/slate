...
pub fn handle_with_env(
    ...
    // Phase 17 Plan 06 — nvim install + D-09 consent prompt.
    //
    ...
    // Phase 17 — surface the nvim flow's outcome inline, below the
...
// ────────────────────────────────────────────────────────────
// Phase 17 Plan 06 — nvim auto-activation flow (D-09 consent).
// ────────────────────────────────────────────────────────────

/// Outcome of the D-09 3-way consent prompt. Surfaced verbatim in the
...
/// The D-09 3-way consent prompt. Fires cliclack `select` with the
...
mod tests {
    ...
    // ────────────────────────────────────────────────────────────
    // Phase 17 Plan 06 — D-09 nvim activation flow
    // ────────────────────────────────────────────────────────────
