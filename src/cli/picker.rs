//! Interactive 2D crossterm picker for theme and opacity selection.
//! Provides a TUI for navigating themes (vertical) × opacity (horizontal) with
//! live preview, hot-reload, and crash-safe rollback.
//! Per , and 06-CONTEXT.
