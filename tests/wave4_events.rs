//! Wave 4 event-seam integration test (18-05-PLAN.md Task 1 Test 2 + Test 4).
//!
...
//!    its failure event on Phase 20's SoundSink.
...
/// lands in the sink's failure counter. Phase 20's SoundSink will
